...
/* "pandas/_libs/window/indexers.pyx":10
 * 
 * 
 ...
 */
  ...
  /* "pandas/_libs/window/indexers.pyx":48
 *         bint left_closed = False
 *         bint right_closed = False
 *         int index_growth_sign = 1             # <<<<<<<<<<<<<<
 *         ndarray[int64_t, ndim=1] start, end
 ...
 */
  ...
  /* "pandas/_libs/window/indexers.pyx":78
 *     # right endpoint is open
 *     else:
 *         end[0] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "pandas/_libs/window/indexers.pyx":105
 *                 end[i] = i + 1
 *             else:
 *                 end[i] = end[i - 1]             # <<<<<<<<<<<<<<
 * 
 ...
 *     int64_t window_size,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6pandas_5_libs_6window_8indexers_1calculate_variable_window_bounds, NULL, __pyx_n_s_pandas__libs_window_indexers); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
